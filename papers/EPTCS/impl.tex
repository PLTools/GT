...
implement theirs own. There is a number of predefined plugins (see Figure~\ref{listofplugins}), but none of them recieves a special treatment from the
...
\item what is the body of the method which transforms a given constructor (the arguments of the method and their types are specified by the framework)?
...
codegeneration interface the plugin system provides repeats that of \textbf{WHAT}?, which has to be familiar to anyone, who ever implemented
