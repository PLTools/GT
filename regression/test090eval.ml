...
module LetRec = struct
  ...
  class ['me, 'mew2, 'extra] de_bruijn ft = object
...
class de_bruijn fself = object
  inherit [string, int, string, nameless, string list, 'extra] eval_t_t
      fself (fun _ -> assert false) fself
