...
module T : sig
  ...
  @type 'a t3 = GT.int * 'a * GT.string with show,gmap,html,foldl,eq,compare,eval,stateful,show_typed;;

  @type 'a t1 = 'a with show,gmap,html,foldl,eq,compare,eval,stateful,show_typed;;

  @type bindings = (GT.string * GT.int) GT.list with show,gmap,html,foldl,eq,compare,eval,stateful,show_typed;;

  @type 'a u1 = 'a GT.option with show,gmap,html,foldl,eq,compare,eval,stateful,show_typed;;
  ...
  @type t2 = GT.int * GT.string with show,gmap,html,foldl,eq,compare,eval,stateful,show_typed;;
