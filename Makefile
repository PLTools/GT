...
PLUGINS=show gmap #compare eq foldl foldr gmap eval stateful fmt show show_typed html #htmlTy
add_plugins:
	$(eval OBPARAMS  += -I common)
...
REGRES_CASES += 000 001 002  006 007 008 009 010 012 015 016 017 018 019 020 022 023 029 030 031 032 037 041 #001 004 005
#mutual cases
